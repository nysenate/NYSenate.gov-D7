      ...
      <div class="row">
        ...
        <div class="columns medium-6 r-padded-column">
          <label for="bill-issue">Issue</label>
            <input class="c-site-search--box icon_after__search form-text form-text form-autocomplete" type="search" id="edit-bill-issue" name="bill_issue" value="<?php if(!empty($search['bill_issue'])) {print $search['bill_issue'];} ?>" size="60" maxlength="128" autocomplete="OFF" aria-autocomplete="list">
            <input type="hidden" id="edit-bill-issue-autocomplete" value="/index.php?q=taxonomy/autocomplete/field_issues" disabled="disabled" class="autocomplete">
        </div>
      </div>
      <hr/>
    </div>
