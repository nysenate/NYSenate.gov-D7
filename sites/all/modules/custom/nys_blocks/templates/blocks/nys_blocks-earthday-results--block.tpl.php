...
<div class="c-block c-block--initiative c-block--initiative__has-img lgt-bg">
    ...
    <a href="<?php print '/' . drupal_get_path_alias(current_path()) . '/earthday' ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'nysenate'); ?>/images/earth_day_thumb.jpg" width="280"/></a>

    <div class="c-initiative--content">
        <div class="c-initiative--inner">
            <h4 class="c-initiative--title">NYS Senate Earth Day Competition Results</h4>
        </div>
    </div>
