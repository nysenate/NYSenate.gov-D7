...
<div id="section-0" class="l-row l-row--hero">
	...
	<div class="l-row l-row--main c-hero--tout">
		<div class="c-about--welcome">
			...
			<p> This website aides in that effort. NYSenate.gov is designed to increase public participation in the legislative process. By facilitating efficient communication between individual New Yorkers and the senators who represent them, lawmakers are able to craft a better set of laws by which we are governed.</p>
		</div>
	</div>
</div>
