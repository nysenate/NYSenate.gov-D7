		...
		<div class="l-row">
			...
			<div class="c-senator-footer-col c-senator-footer-col__social">
				...
				<ul>
					...
					<?php endif; ?>
					<?php if(isset($node->field_instagram_url['und'][0]['value'])): ?>
                        <li><a href="<?php print $node->field_instagram_url['und'][0]['value']; ?>" class="lgt-text icon-replace__instagram2" target="_blank">instagram</a></li>
                    <?php endif; ?>
				</ul>
			</div>
			<?php endif; ?>
