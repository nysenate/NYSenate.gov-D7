...
<div class="c-block c-list-item c-legislation-block">
  <div class="c-bill-meta">
    <h3 class="c-bill-num"><a href="<?php echo $resolution_path; ?>" alt="<?php echo $title ?>">Reso. <?php echo $title ?></a></h3>
    <h4 class="c-bill-topic"><?php echo render($content['field_issues']); ?></h4>
  </div>
  <div class="c-bill-body">
    <p class="c-bill-descript"><a href="<?php echo $resolution_path; ?>"><?php echo truncate_utf8(render($content['field_ol_name']), 135, TRUE, TRUE, 132); ?></a></p>
    <div class="c-bill-update">
      <p class="c-bill-update--date">
       <?php if($resolution_status) echo date("M d, Y", $resolution_status_date); ?>
        <?php if($resolution_status->text) echo '&nbsp;&nbsp;|&nbsp;&nbsp;' . $resolution_status->text; ?>
