...
<div class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="c-detail--social">
    ...
    <ul>
      ...
      <li><a target="_blank" href="https://twitter.com/intent/tweet?text=<?php print $title; ?> Via: @nysenate: <?php print $node_url; ?>" class="c-detail--social-item twitter">twitter</a></li>
