...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <?php if ($page): ?>
    <header class="c-news--head">
        <h1 class="nys-article-title">Poll Question</h1>
    </header>
  <?php endif; ?>
    
  <div class="c-block--pg-poll">
    <div class="c-block c-block--initiative c-block--initiative__has-img lgt-bg">
      <?php print render($content['field_image_main']); ?>
      <div class="c-initiative--content c-initiative--inner">
  ...
  <p class="c-advpoll--date"><strong>Poll Availability:</strong><br>
    <span><?php print render($content['advpoll_dates']); ?></span>
  </p>  
