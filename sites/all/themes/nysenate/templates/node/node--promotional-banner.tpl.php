...
<?php //kpr($node); ?>
  ...
  <div class="c-block c-block--initiative c-block--initiative__has-img lgt-bg">
    ...
    <a href="<?php $link_type_value == 'external' ? print $external_web_page_safe_value : print url('node/' . $promotional_content_target_id); ?>">
      <?php print render($content['field_image_main']); ?></a>
