...
<div class="c-block c-meeting-detail--header">
  <?php if ($content['field_video_status']['#items'][0]['value'] === "cancelled"): ?>
  ...
  <div class="c-meeting-detail--overview">
    ...
    <div class="c-meeting-detail--info">
      ...
      <p class="c-meeting-detail--location">
        <?php if (!empty($content['field_meeting_location']['#items'][0]['value'])): echo $content['field_meeting_location']['#items'][0]['value'] . '<br>'; endif; ?>
