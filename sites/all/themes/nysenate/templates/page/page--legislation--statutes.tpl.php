<?php
/*
 * This file is necessary only because page--legislation.tpl.php exists,
 * and renders a title above the content section.
 *
 * After removal of the old statute URLs and templates, this can revert
 * back to page.tpl.php.
 */
 ?>
<!--.page -->
