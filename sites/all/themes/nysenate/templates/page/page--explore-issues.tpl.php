...
<div role="document" class="page">
	...
	<main role="main" class="l-row l-row--main l-main">
		<div class="<?php print $main_grid; ?> <!--main columns-->">
			...
			<?php endif; ?>
			<section class="c-news_issues--head">
			  <h2 class="nys-title">Explore Issues</h2>
			  <p class="nys-subtitle">
			      Find and follow issues that are currently being discussed and worked on in the New York State Senate.
			  </p>
			</section>
