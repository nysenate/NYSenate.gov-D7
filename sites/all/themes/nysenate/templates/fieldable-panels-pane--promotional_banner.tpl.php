...
<?php //dpm($content); ?>
        ...
        <div class="c-block c-block--initiative c-block--initiative__has-img lgt-bg">
            ...
            <a href="<?php $content['field_link_type']['#items'][0]['value'] == 'external' ? print $external_web_page_safe_value : print url('node/' .  $promotional_content_target_id); ?>"><?php print render($content['field_image_main']); ?></a>
