...
<div class="c-event-block c-event-block--list">
  ...
  <div class="c-event-time">
    <div class="c-location">
      ...
      <?php if($view->current_display != 'page' && isset($fields['field_date_1']->content)): ?>
      <div class="icon-before__calendar-month">
          <?php echo $fields['field_date_2']->content . ' @ '. $fields['field_date_1']->content;?>
    </div>
      <?php endif; ?>
    <?php if(isset($fields['field_video_status']->content)):?>
       <?php if($view->current_display != 'page'):?><?php endif;?><a href="<?php print $fields['path']->content;?>"><div class="c-video-status icon-before__youtube">
              <?php echo $fields['field_video_status']->content; ?></a>
      </div>
    <?php endif; ?>
  </div>
</div>
