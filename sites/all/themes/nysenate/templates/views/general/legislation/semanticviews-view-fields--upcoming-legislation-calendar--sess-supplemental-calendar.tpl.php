...
$this_counter = (int) $fields['counter']->content;
?>
<div class="c-update-block">
  ...
  <div class="l-right-actions">
    ...
    <p class="c-calendar--num"><span class="c-calendar--num-mark">cal no. </span><?php echo $row->field_field_ol_bill_cal_number[$this_counter]['raw']['value']; ?></p>
    <?php else: ?>
