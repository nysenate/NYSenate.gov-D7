  ...
  <section class="c-block calendar-nav">
    <div class="cal-nav-wrapper">
      ...
      <ul class="cal-nav-list">
        <?php if($view->current_display != 'page'): ?><li><a href="/events" class="cal-nav-link icon-after__calendar-day">View By Day</a></li><?php endif; ?>
        <?php if($view->current_display != 'week'): ?><li><a href="/events/week" class="cal-nav-link icon-after__calendar-week">View By Week</a></li><?php endif; ?>
