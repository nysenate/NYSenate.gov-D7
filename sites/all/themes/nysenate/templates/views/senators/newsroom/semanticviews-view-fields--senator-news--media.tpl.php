...
?>
  <section class="c-block c-block-download">
    ...
    <div class="c-download-contact-block c-download-contact-block-2">
      ...
      <?php if (!empty($email)) { ?><p class="c-download-contact--email"><?php print $email; ?></p><?php } ?>
      <?php if (!empty($phone)) { ?><p class="c-download-contact--phone">Phone: <?php print $phone; ?></p><?php } ?>
      <?php if (!empty($fax)) { ?><p class="c-download-contact--fax">Fax: <?php print $fax; ?></p><?php } ?>
    </div>
