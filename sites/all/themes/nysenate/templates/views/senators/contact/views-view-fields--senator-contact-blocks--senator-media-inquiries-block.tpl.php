	...
	<div class="c-block c-block--senator-media">
		...
		<div class="l-col l-col-2">
			<ul class="c-senator-media--contact">
				<?php if(isset($fields['contact_name']->raw)): ?>
					<li class="c-senator-media--item"><?php print $fields['contact_name']->raw; ?></li>
				<?php endif; ?>
				<?php if(isset($fields['email']->raw)): ?>
					<li class="c-senator-media--item"><a href="mailto:<?php print $fields['email']->raw; ?>"><?php print $fields['email']->raw; ?></a></li>
				<?php endif; ?>
				<?php if(isset($fields['phone']->raw)): ?>
                    <li class="c-senator-media--item"><span>Phone: </span><?php print $fields['phone']->raw; ?></li>
				<?php endif; ?>
				<?php if(isset($fields['fax']->raw)): ?>
					<li class="c-senator-media--item"><span>Fax: </span><?php print $fields['fax']->raw; ?></li>
				<?php endif; ?>
			</ul>
		</div>
	</div>
