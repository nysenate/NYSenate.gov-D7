      ...
      <div>
        ...
        <div class="c-senator-hero--info-secondary">
          ...
          <p class="c-senator-hero--district">
            <?php if((isset($fields['field_party']->content) || isset($fields['field_conference']->content)) && $fields['field_active']->content === 'active'): ?>
            ...
            <?php endif; ?>
            <?php if(isset($fields['field_district_number']) && $fields['field_active']->content === 'active'): ?>
