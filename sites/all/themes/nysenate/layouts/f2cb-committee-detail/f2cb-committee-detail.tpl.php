...
<?php !empty($css_id) ? print '<div id="' . $css_id . '">' : ''; ?>
  <?php //var_dump($content["top"]); die(); ?>
  <div class="l-row l-row--hero l-row--hero-committee">
  ...
  <div class="l-row">
    <?php print $content['below_top']; ?>
  </div>
  <div class="l-row">
      <dl class="l-tab-bar" data-tab>
        <div class="c-tab--arrow u-mobile-only"></div>
        <dd class="c-tab active"><a class="c-tab-link first" href="#panel1">All Updates</a></dd>
        <dd class="c-tab"><a class="c-tab-link" href="#panel2">News</a></dd>
        <dd class="c-tab"><a class="c-tab-link" href="#panel3">Events Archive</a></dd>
      </dl>
