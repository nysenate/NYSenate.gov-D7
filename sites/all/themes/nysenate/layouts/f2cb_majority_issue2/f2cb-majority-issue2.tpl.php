...
<div class="l-row c-block">
    <dl class="l-tab-bar" data-tab>
        ...
        <dd class="c-tab">
            <a class="c-tab-link" href="#panel2" id="tab2">Covid-19</a>
        </dd>
        <dd class="c-tab">
            <a class="c-tab-link" href="#panel3" id="tab3">Senate Employees</a>
        </dd>
        <dd class="c-tab">
            <a class="c-tab-link" href="#panel4" id="tab4">Bills</a>
        </dd>
    </dl>
