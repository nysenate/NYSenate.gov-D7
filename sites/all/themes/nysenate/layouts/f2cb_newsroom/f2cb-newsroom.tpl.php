...
<?php !empty($css_id) ? print '<div id="' . $css_id . '">' : ''; ?>
  <?php if((arg(0) == 'node') && is_numeric(arg(1))):?><h2 class="nys-title">Newsroom</h2><?php endif; ?>
  <div class="l-row">
  ...
  <div class="l-row">
    ...
    <dl class="l-tab-bar" data-tab>
      ...
      <dd class="c-tab all active"><a class="c-tab-link first" href="#panel1">All News</a></dd>
      <dd class="c-tab press"><a class="c-tab-link" href="#panel2">Press Releases</a></dd>
      <dd class="c-tab video"><a class="c-tab-link" href="#panel3">Videos</a></dd>
    </dl>
