  ...
  <div class="row">
    <div class="large-12 columns">
      <dl class="l-tab-bar" data-tab>
        <div class="arrow icon-replace__see-more"></div>
        <dd class="c-tab active"><a class="c-tab-link first" href="#panel1">Recently Passed By Senate</a></dd>
        <dd class="c-tab"><a class="c-tab-link" href="#panel2">Recently Signed By The Governor</a></dd> 
      </dl>
